...
function setup(){
    ...
    particle1 = Bodies.circle(218,10,10,particle_options);
    World.add(world,particle1);
    particle2 = Bodies.circle(219,10,10,particle_options);
    World.add(world,particle2);
    particle3 = Bodies.circle(220,10,10,particle_options);
    World.add(world,particle3);
    particle4 = Bodies.circle(221,10,10,particle_options);
    World.add(world,particle4);
    particle5 =Bodies.circle(223,10,10,particle_options);
    World.add(world,particle5);
     particle6 = Bodies.circle(217,10,10,particle_options);
    World.add(world,particle6);
    particle7= Bodies.circle(218,10,10,particle_options);
    World.add(world,particle7);
    particle8 = Bodies.circle(220,10,10,particle_options);
    World.add(world,particle8);
    particle9 = Bodies.circle(221,10,10,particle_options);
    World.add(world,particle9);
    particle10 =Bodies.circle(223,10,10,particle_options);
